...
li t1, 9
sw t1, 12(fp)    # set x to 9
mv t0, sp
addi t0, t0, 12
mv t1, t0
sw t1, 8(fp)     # set the address of the return variable to sp + 12 (_T1)
...
mv t0, sp
addi t0, t0, 12
sw t1, 0(t0)     # store the value of _T0 to x (*(sp + 12))
p_f_2:
li t1, 0
mv t0, sp
addi t0, t0, 8
